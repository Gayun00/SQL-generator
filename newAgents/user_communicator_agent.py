...
# LLM 호출 시뮬레이션
class MockLLMClient:
    def check_ambiguity(self, query: str) -> bool:
    ...
    def translate_request_to_question(self, request: Dict[str, Any]) -> str:
...
class UserCommunicator:
    ...
    def process(self, message: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if message.get("user_response"):
            ...
            next_agent = context.pop("requesting_agent", "schema_analyzer") # 요청 에이전트로 돌아가거나 기본값으로 설정
        ...
        # 2. 다른 에이전트의 요청 처리
            ...
            question = self.llm_client.translate_request_to_question(message.get("content"))
        ...
        # 3. 최초 사용자 입력 처리
            ...
            if self.llm_client.check_ambiguity(query):
